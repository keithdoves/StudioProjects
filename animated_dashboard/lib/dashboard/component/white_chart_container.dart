...
class WhiteChartContainer extends StatefulWidget {
  final String text;
  final Color color;
  ...
  @override
  State<WhiteChartContainer> createState() => _WhiteChartContainerState();
}

class _WhiteChartContainerState extends State<WhiteChartContainer> {
