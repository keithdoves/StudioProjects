...
import 'package:task_hub/measurable_container.dart';

import 'common/const/responsive.dart'; // 새로 생성한 파일 import
...
class DashboardContent extends StatefulWidget {
  ...
  static const double desktopBreakpoint =
      TABLET_MIN_WIDTH; // 데스크톱 레이아웃으로 전환될 너비
  static const double tabletBreakpoint =
      (DESKTOP_WIDE_MIN_WIDTH + TABLET_MIN_WIDTH) / 2;
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          if (constraints.maxWidth < DashboardContent.tabletBreakpoint) {
            // 모바일 레이아웃 (600px 미만)
            return _buildMobileLayout();
          } else if (constraints.maxWidth <
              DashboardContent.desktopBreakpoint) {
            // 태블릿 레이아웃 (600px ~ 1100px)
  ...
  return SingleChildScrollView(
    child: Column(
      children: [
        ...
        // A3 (1열)
        MeasurableContainer(
            text: 'A3', color: Colors.red[100]!, minWidth: 300, maxHeight: 300),
        // B1 (1열)
        MeasurableContainer(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Align(
                      ...
                      child: MeasurableContainer(
                          text: 'A3', color: Colors.red[100]!, minWidth: 300),
                    ),
                  ),
                ],
              ),
      ...
      Expanded(
        ...
        child: Row(
          ...
          children: [
            Expanded(
                child: MeasurableContainer(
                    text: 'C1', color: Colors.blue[100]!, minWidth: 150)),
            Expanded(
                child: MeasurableContainer(
                    text: 'C2', color: Colors.blue[100]!, minWidth: 150)),
          ],
        ),
      ),
    ],
